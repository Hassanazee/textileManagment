        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DisabledComments = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    AppUserConfigurationId = table.Column<long>(type: "bigint", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_AppUserConfigurationId",
                table: "AspNetUsers",
                column: "AppUserConfigurationId",
                unique: true,
                filter: "[AppUserConfigurationId] IS NOT NULL");
